...
<blockquote>
<p>countryMedalsPivotDf = sparkSess.sql(’’‘SELECT * FROM ( SELECT NOC, Medal FROM olympicMedalWinnersTbl)   PIVOT ( count(1) FOR Medal IN (‘Gold’ GOLD, ‘Silver’ SILVER, ‘Bronze’ BRONZE) )   ORDER BY NOC  LIMIT 10   ‘’’)</p>
</blockquote>
